...
# PCA projection
Projection of principle components is achieved by multiplying a new data set by previously generated eigenvectors, or gene loadings. The \texttt{projectoR} function has S3 method for class \texttt{prcomp}.  
