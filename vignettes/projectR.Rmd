...
For the current development version, start R, and run:
```
library(BiocManager)
...
library(projectR)
data(map.ESepiGen4c1l)
data(p.ESepiGen4c1l) 
data(pd.ESepiGen4c1l) 

PCA2ESepi <- projectR(data=p.ESepiGen4c1l$mRNA.Seq,
                      AnnotionObj=map.ESepiGen4c1l, 
                      IDcol="GeneSymbols",
                      Patterns=pc.RNAseq6l3c3t,
                      full=TRUE) 
