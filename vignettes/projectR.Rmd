...
library(projectR)
PCA2ESepi <- projectR(p.ESepiGen4c1l$mRNA.Seq,Patterns=pc.RNAseq6l3c3t,full=T, 
...
```{r projectR.CoGAPSex,eval=FALSE, warning=FALSE}
# data to project into PCs from RNAseq6l3c3t expression data 
library(projectR)
data(ESepiGen4c1l4)
data(Patterns.RNAseq6l3c3t)

NMF2ESepi <- projectR(p.ESepiGen4c1l$mRNA.Seq,Patterns=AP,full=T, 
    AnnotionObj=map.ESepiGen4c1l, IDcol="GeneSymbols")
...
```{r cluster2pattern-fn, eval=FALSE}
library(projectR)
...
```{r projectR.correlaeR, eval=FALSE}
