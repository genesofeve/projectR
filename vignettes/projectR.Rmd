...
```
library(projectR)
projectR(data, Patterns, AnnotationObj = NA, IDcol = "GeneSymbol",
 NP = NA, full = FALSE)
```
...
\item[AnnotationObj]{an Annotation object for data. If NA the rownames of data will be used.}
\item[IDcol]{the column of AnnotationData object corresponding to identifiers matching the type used for GeneWeights}
...
```
library(projectR)
projectR(data = NA, AnnotationObj = NA, IDcol = "GeneSymbol",
